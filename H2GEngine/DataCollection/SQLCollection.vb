    ...
    Private Sub Between(ByVal condition As String, ByVal name As String, ByVal column As String, ByVal value_from As String, ByVal value_to As String, ByVal type As DbType)
        Select Case type
            Case DbType.Date, DbType.DateTime, DbType.DateTime2
                ...
                If (Not String.IsNullOrEmpty(value_from)) Then value_from = Format(H2G.Convert(Of DateTime)(value_from), "yyyy-MM-dd")
                If (Not String.IsNullOrEmpty(value_to)) Then value_to = Format(H2G.Convert(Of DateTime)(value_to), "yyyy-MM-dd")
            Case DbType.String
