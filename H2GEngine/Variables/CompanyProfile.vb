Public Class CompanyProfile
    ...
    Public Shared Property VoucherExpenseTo() As Boolean
        Get
            Return H2G.Bool(Column("voucher_show_expense_to"))
        End Get
    ...
    Public Shared Property AllowFax() As Boolean
        Get
            Return H2G.Bool(Column("allow_fax"))
        End Get
        Set(ByVal value As Boolean)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Public Shared Property AllowSMS() As Boolean
        Get
            Return H2G.Bool(Column("allow_sms"))
        End Get
        Set(ByVal value As Boolean)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Public Shared Property AllowInvoiceNoVatInTax() As Boolean
        Get
            Return H2G.Bool(Column("allow_invoice_novat_in_tax"))
        End Get
        Set(ByVal value As Boolean)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Public Shared Property AllowNoVatInTax() As Boolean
        Get
            Return H2G.Bool(Column("allow_novat_in_tax"))
        End Get
        Set(ByVal value As Boolean)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Public Shared Property AutoUpdateDescription()
        Get
            Return H2G.Bool(Column("auto_update_desc"))
        End Get
        Set(ByVal value)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Public Shared Property LockInvoiceDate()
        Get
            Return H2G.Bool(Column("lock_invoice_date"))
        End Get
        Set(ByVal value)
            Dim update As String = "N"
            If (value) Then update = "Y"
        ...
        End Set
    End Property
    Public Shared Property LockDueDate()
        Get
            Return H2G.Bool(Column("lock_due_date"))
        End Get
        Set(ByVal value)
            Dim update As String = "N"
            If (value) Then update = "Y"
            Save("lock_due_date", update)
        End Set
    End Property
    Public Shared Property LockReceiptDate()
        Get
            Return H2G.Bool(Column("lock_receipt_date"))
        End Get
        Set(ByVal value)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Public Shared Property LockPaymentDate()
        Get
            Return H2G.Bool(Column("lock_payment_date"))
        End Get
        Set(ByVal value)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Public Shared Property LockTaxDate()
        Get
            Return H2G.Bool(Column("lock_tax_date"))
        End Get
        Set(ByVal value)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Public Shared Property NoneBSP_AMADEUS() As Boolean
        Get
            Return H2G.Bool(Column("amadeus_nonbsp"))
        End Get
        Set(ByVal value As Boolean)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Public Shared Property AMADEUS() As Boolean
        Get
            Return H2G.Bool(Column("amadeus"))
        End Get
        Set(ByVal value As Boolean)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Public Shared Property GALILEO() As Boolean
        Get
            Return H2G.Bool(Column("galileo"))
        End Get
        Set(ByVal value As Boolean)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Public Shared Property ShowTicketPrice() As Boolean
        Get
            Return H2G.Bool(Column("show_ticket_price"))
        End Get
        Set(ByVal value As Boolean)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Public Shared Property RequireTicket() As Boolean
        Get
            Return H2G.Bool(Column("require_ticket"))
        End Get
        Set(ByVal value As Boolean)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Public Shared Property BookingNODigit() As Integer
        Get
            Return H2G.Bool(Column("booking_digit"))
        End Get
    ...
    Public Shared Property MBOSSmall() As Boolean
        Get
            Return H2G.Bool(Column("mbos_small"))
        End Get
        Set(ByVal value As Boolean)
            Dim update As String = "N"
            If (value) Then update = "Y"
    ...
    Protected Shared Function Column(ByVal name As String) As String
        ...
        Return base.QueryField(String.Format("SELECT TOP 1 {0} FROM company_profile", name))
    End Function
    Protected Shared Sub Save(ByVal name As String, ByVal value As String)
        Dim base As New DBQuery()
        base.Execute(String.Format("UPDATE company_profile SET update_date=GETDATE(),update_staff={2},{0}='{1}'", name, value, H2G.Login.ID))
        Try
            base.Apply()
        Catch
            base.Rollback()
    ...
    Public Shared Property LimitBooking() As Integer
        Get
            Return H2G.Int(Column("limit_booking"))
        End Get
        Set(ByVal value As Integer)
    ...
    Public Shared Property LimitStaff() As Integer
        Get
            Return H2G.Int(Column("limit_staff"))
        End Get
        Set(ByVal value As Integer)
    ...
    Public Shared Property LimitDueDate() As String
        ...
        End Get
        Set(ByVal value As String)
            Save("CONVERT(VARCHAR, limit_duedate, 105)", value)
        End Set
    End Property
    Public Shared Property RequireInvoiceDuedate() As Boolean
        Get
            Return H2G.Bool(Column("require_invoice_duedate"))
        End Get
        Set(ByVal value As Boolean)
            Dim update As String = "N"
            If (value) Then update = "Y"
            Save("require_invoice_duedate", update)
        End Set
    End Property
    Public Shared Property PaymentPaidLimit() As Boolean
        Get
            Return H2G.Bool(Column("payment_limit"))
        End Get
        Set(ByVal value As Boolean)
            Dim update As String = "N"
            If (value) Then update = "Y"
            Save("payment_limit", update)
        End Set
    End Property
End Class