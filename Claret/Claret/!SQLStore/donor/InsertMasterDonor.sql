insert into donor(id, Donor_Number, Gender, Name, Surname, Name_E, Surname_E, Title_ID, Address, Province, Zipcode, Country_ID
...
values(:id, :Donor_Number, :Gender, :Name, :Surname, :Name_E, :Surname_E, :Title_ID, :Address, :Province, :Zipcode, :Country_ID
, :Occupation_ID, :Nationality_ID, :Race_ID, :Tel_Mobile1, :Tel_Mobile2, :Tel_Home, :Tel_Office, :Tel_Office_Ext, :Email, :Association_ID, :Visit_Number
