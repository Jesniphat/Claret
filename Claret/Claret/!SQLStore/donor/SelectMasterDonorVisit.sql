...
, to_date(to_char(nvl(DV.visit_date,nvl(dv.Create_Date,sysdate)),'dd/mm/yyyy'),'dd/mm/yyyy') - to_date(to_char(nvl(dor.Last_Visit_Date,sysdate),'dd/mm/yyyy'),'dd/mm/yyyy') as diff_date 
