...
Public Class MasterPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim dt As DataTable = Cbase.QueryTable("select st.firstname || ' ' || st.lastname || ' (' || st.code || ')' as staff_name, cp.code || ' : ' || cp.name as point_name 
                                                ...
                                                from staff st 
                                                cross join (select CP.plan_date, CPT.name, CPT.code from COLLECTION_PLAN cp 
        ...
        If dt.Rows.Count > 0 Then
            strUserInfo = dt.Rows(0)("point_name").ToString()
